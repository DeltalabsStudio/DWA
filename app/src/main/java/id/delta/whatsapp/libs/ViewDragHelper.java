...
package id.delta.whatsapp.libs;
...
public class ViewDragHelper {
    ...
    /**
     * Tests scrollability within child views of v given a id.delta of dx.
     *
     ...
     * @return true if child views of v can be scrolled by id.delta of dx.
     */
