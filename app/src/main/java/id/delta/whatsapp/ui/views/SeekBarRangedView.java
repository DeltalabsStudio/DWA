...
public class SeekBarRangedView extends View {
    ...
    private static final int DEFAULT_COLOR = 0xffFFFF00 ; //Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    private static final int DEFAULT_BACKGROUND_COLOR = 0x80FFFF00; //Color.argb(0xFF, 0xC0, 0xC0, 0xC0);
    ...
    private void setupAttrs(Context context, AttributeSet attrs) {
     //   TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SeekBarRangedView, 0, 0);
        ...
        try {
            min = DEFAULT_MIN_PROGRESS;
            currentMin = min;
            max = DEFAULT_MAX_PROGRESS;
            currentMax = max;
            progressHeight = DEFAULT_PROGRESS_HEIGHT;
            bgProgressHeight = DEFAULT_PROGRESS_HEIGHT;
            mRounded = false;
            mProgressColor = DEFAULT_COLOR;
            mProgressBackgroundColor = DEFAULT_BACKGROUND_COLOR;
