...
public class SeekBarPreference extends DialogPreference {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try{
            ...
            mSeekBar.setId(Tools.intId("seekbar"));
            /*
             ...
             */
            mSeekBar.getProgressDrawable().setColorFilter(Colors.setWarnaAksen(), PorterDuff.Mode.SRC_ATOP);
            mSeekBar.getThumb().setColorFilter(Colors.setWarnaAksen(), PorterDuff.Mode.SRC_ATOP);
    ...
    protected void onBindDialogView(View view) {
        ...
        mStatusText = (TextView) view.findViewById(Tools.intId("seekBarPrefValue"));
    ...
    protected void onAddSeekBarToDialogView(View dialogView, SeekBar seekBar) {
        ViewGroup container = (ViewGroup) dialogView.findViewById(Tools.intId("seekbar_container"));
        if (container != null) {
    ...
    /**
     * Returns the {@link SeekBar} widget that will be shown in the dialog.
     *
     * @return The {@link SeekBar} widget that will be shown in the dialog.
     */
